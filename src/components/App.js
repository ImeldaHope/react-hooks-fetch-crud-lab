...
function App() {
  ...
  return (
    <main>
      ...
      {page === "Form" ? <QuestionForm handleSubmitForm= {handleSubmittedForm}/> : <QuestionList questionList ={questions} handleDeletedQuiz={handleDeletedQuiz} handleUpdatedQuiz={handleUpdatedQuiz}/>}
    </main>
  );
}
